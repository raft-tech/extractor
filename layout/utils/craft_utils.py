...
def load_model(weight_path, cuda=False, freeze=False, eval=True, refine_net=False):
    if refine_net:
        net = RefineNet()
    else:
...
def saveResult(img_file, img, boxes, dirname='./result/', verticals=None, texts=None):
    ...
    # result directory
    res_file = os.path.join(dirname, "res_{}.txt".format(filename))
    res_img_file = os.path.join(dirname, "res_{}.jpg".format(filename))
